            ...
            var booksAuthors = new List<BookAuthor>()
            {
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        {
                            new Review { Headline = "Awesome Book", ReviewText = "Reviewing Call of the Wild and it is awesome beyond words",
                             Reviewer = new Reviewer(){ FirstName = "John", LastName = "Smith" } },
                            new Review { Headline = "Terrible Book", ReviewText = "Reviewing Call of the Wild and it is terrrible book",
                             Reviewer = new Reviewer(){ FirstName = "Peter", LastName = "Griffin" } },
                            new Review { Headline = "Decent Book", ReviewText = "Not a bad read, I kind of liked it",
                ...
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        Reviews = new List<Review>()
                        {
                            new Review { Headline = "Awesome Western Book", ReviewText = "Reviewing Winnetou and it is awesome book",
                ...
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        Reviews = new List<Review>()
                        {
                            new Review { Headline = "Awesome Programming Book", ReviewText = "Reviewing Pavols Best Book and it is awesome beyond words",
                ...
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        Reviews = new List<Review>()
                        {
                            ...
                            new Review { Headline = "Horrible Romantic Book", ReviewText = "My wife made me read it and I hated it", 
